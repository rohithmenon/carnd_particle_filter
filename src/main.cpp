...
int main() {
  ...
  ParticleFilter pf(sensor_range, sigma_landmark, sigma_pos);
          ...
          if (s != "") {
            ...
            if (event == "telemetry") {
              ...
              if (!pf.Initialized()) {
                ...
                pf.ReportMotion(delta_t, previous_velocity, previous_yawrate);
              }
              ...
              json msgJson;
              const auto &particle_state = best_particle.GetState();
              msgJson["best_particle_x"] = particle_state[0];
              msgJson["best_particle_y"] = particle_state[1];
              msgJson["best_particle_theta"] = particle_state[2];
